    ...
    <footer className='footer'>
        ...
        <nav className='footer__social-links-container'>
            <a className='footer__social-link' href='#'>
                <img className='footer__social-link' src={facebook} alt="Иконка Facebook" />
            </a>
            <a className='footer__social-link' href='#'>
            <img className='footer__social-link' src={google} alt="Иконка Google" />
            </a>
            <a className='footer__social-link' href='#'>
                <img className='footer__social-link' src={twitter} alt="Иконка Twitter" />
            </a>
            <a className='footer__social-link' href='#'>
                <img className='footer__social-link' src={pin} alt="Иконка Pinterest" />
            </a>
        </nav>
        ...
        <div className='footer__columns-container'>
            ...
            <nav className='footer__column'>
                ...
                <ul className='footer__column-list'>
                    <li className='footer__column-list-item'><a href="#contact">Как с нами связаться?</a></li>
                    <li className='footer__column-list-item'><a href="#digital">Что такое диджитал?</a></li>
                    <li className='footer__column-list-item'><a href="#pricing">Стоимость услуг</a></li>
                </ul>
            </nav>
            ...
            <nav className='footer__column'>
                ...
                <ul className='footer__column-list'>
                    <li className='footer__column-list-item'><a href="#projects">Наши проекты</a></li>
                    <li className='footer__column-list-item'><a href="#team">Команда</a></li>
                    <li className='footer__column-list-item'><a href="#blog">Блог</a></li>
                </ul>
            </nav>
